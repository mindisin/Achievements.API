        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompletionDay = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AchievementCompetition", x => new { x.AchievementsId, x.CompetitionsId });
                    table.ForeignKey(
                        name: "FK_AchievementCompetition_Achievements_AchievementsId",
                        column: x => x.AchievementsId,
                        principalTable: "Achievements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AchievementCompetition_Competitions_CompetitionsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompetitionUser", x => new { x.CompetitionsId, x.MembersId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompetitionUser_Users_MembersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AchievementCompetition_CompetitionsId",
                table: "AchievementCompetition",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompetitionUser_MembersId",
